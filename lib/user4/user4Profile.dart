...
class user4Profile extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return user4ProfileState();
  }
}
class user4ProfileState extends State<user4Profile>{
  myApp m=new myApp();
  bool switch1=true;
  @override
                ...
                children: [
                  ...
                  GestureDetector(
                    child: Container(
                      ...
                      child: Row(
                        children: [
                          Text("My Courses",style: TextStyle(fontSize: 17,fontWeight: FontWeight.bold),),

                        ],
                      ),

                    ),
                    onTap: (){Navigator.pushNamed(context, '/myCourses');},
                  ),
                  SizedBox(  height: MediaQuery.of(context).size.height*.02,),
                  GestureDetector(
                    child: Container(
