...
class user4Main extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return user4MainState();
  }
}
class  user4MainState extends State<user4Main>{
  myApp m=new myApp();
  String lang = "";
  loadData() async {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          onTap: () {
                            Navigator.pushNamed(
                                context, '/onlineCourseInformation');
                          },
                        ),
                        SizedBox(
                          height: MediaQuery.of(context).size.height *
