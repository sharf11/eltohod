...
class individualSignUp extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return individualSignUpState();
  }
}
class individualSignUpState extends State<individualSignUp>{
  bool radio=true;
  bool check=true;
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Container(
                            alignment: Alignment.centerLeft,
                            child: Text("Medical Speciality",style: TextStyle(fontSize: 12),textAlign: TextAlign.start,)),
                        SizedBox(height: MediaQuery.of(context).size.height *.008,),
                        Container(
                          decoration: BoxDecoration(
                              borderRadius:BorderRadius.all(Radius.circular(10)),
