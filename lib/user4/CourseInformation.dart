...
class onlineCourseInformation extends StatefulWidget{
  @override
  State<StatefulWidget> createState() {
    return onlineCourseInformationState();
  }
}
class onlineCourseInformationState extends State<onlineCourseInformation>{
  myApp m=new myApp();
  bool radio=true;
                 ...
                 Container(
                   ...
                   child: Column(
                     ...
                     children: [
                         ...
                         children: [
                           GestureDetector(
                             child: Container(
                               ...
                               child: Text("Online",style: TextStyle(color:Colors.white,fontSize: 15,fontWeight: FontWeight.bold)
                           ...
                           GestureDetector(
                             child: Container(
                               ...
                               child:  Text("In Center",style: TextStyle(color: Colors.black,fontSize: 15,fontWeight: FontWeight.bold)
                                   ,textAlign: TextAlign.center),
                       ...
                       Text("Course Options",style: TextStyle(fontSize: 14,),),
                         ...
                         children: [
                           GestureDetector(
                             child: Container(
                               ...
                               child: Text("Online",style: TextStyle(color: bookType=='video'?Colors.white:Colors.black,fontSize: 15,fontWeight: FontWeight.bold)
                                 ,textAlign: TextAlign.center,),
                           ...
                           GestureDetector(
                             child: Container(
                               ...
                               child:  Text("Offline",style: TextStyle(color: bookType=='voice'?Colors.white:Colors.black,fontSize: 15,fontWeight: FontWeight.bold)
                                   ,textAlign: TextAlign.center),
