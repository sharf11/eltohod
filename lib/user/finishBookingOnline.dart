...
class finishBookingOnline extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return finishBookingOnlineState();
  }
}
class finishBookingOnlineState extends State<finishBookingOnline>{
  myApp m=new myApp();
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              onTap: (){Navigator.pushNamed(context, '/vedioCall');},
            ),
