...
class paymentOnline extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return paymentOnlineState();
  }
}
class paymentOnlineState extends State<paymentOnline>{
  myApp m=new myApp();
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Text("Bank Transfer",style: TextStyle(fontSize: 15),),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("With pay pal",style: TextStyle(fontSize: 15),),
            ...
            Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text("Online Payment",style: TextStyle(fontSize: 15),),
            ...
            GestureDetector(
              ...
              onTap:(){Navigator.pushNamed(context, '/confirmOnline');},
            ),
          ],
        ),
      ),
