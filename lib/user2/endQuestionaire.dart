...
class endQuestionaire extends StatefulWidget{

  @override
  State<StatefulWidget> createState() {
    return endQuestionaireState();
  }
}
class endQuestionaireState extends State<endQuestionaire>{
  void initState() {
    super.initState();
  }
  myApp m=new myApp();
  ...
  Widget build(BuildContext context) {
   Timer(Duration(seconds: 5), ()=>Navigator.of(context)
        .pushNamedAndRemoveUntil('/user2Main',
        ...
        child: Column(
          ...
          myAppBar("Questionaire"),
            ...
            Container(
                ...
                child: Text("For Helping Our Researcher",style: TextStyle(color:Colors.black,fontSize: 17,fontWeight: FontWeight.bold),textAlign: TextAlign.center,))
